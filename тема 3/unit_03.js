...
// содержимое i-1 и сравнить его с числом 4 (сравнение ==). Результат
//  сравнения - true или false выведите в out-1.

function f1 ( ) {
let inus = document.querySelector(".i-1").value;
...
// Функция должна сравнить переменные с помощью 
// if else и вывести в out-2 число, которое больше. 
// Вариант равенства переменных не рассматриваем.

let a21 = 45;
let a22 = 66;
b2 = document.querySelector(".out-2")
...
//  Функция должна вычитать содержимое i-31 и i-32 в 
//  переменные и сравнить их, вывести в  out-3 большее число.
//     Проведите самостоятельный тест работы, 
// введите пары чисел 4 и 9, 9 и 22, 5 и 111.

let inp31 = document.querySelector('.i-31')
let inp32 = document.querySelector('.i-32')
let out3 = document.querySelector('.out-3')
function f3(){
    inp31val = inp31.value;
    inp32val = inp32.value;
   
    if (inp31val > inp32val)
    {
    out3.innerHTML = inp31.value;
    }
    else {
    out3.innerHTML = inp32.value;
    }
}
...
// Task 4. Создайте на странице input[type=number] с классом 
// i-4, куда пользователь может ввести год своего рождения. 
// Есть кнопка b-4 которая запускает функцию f4. Функция должна 
// вывести в  .out-4 число 1 если пользователю больше или 
// равно 18 лет, и 0 если меньше.

inpYear = document.querySelector(".i-4")
out4 = document.querySelector(".out-4")
function f4(){
    inpYearval = inpYear.value;
    ageabs = 2024 - inpYearval;
    console.log(ageabs)
    if(ageabs > 18){
        out4.innerHTML = 1
    }
...
// Task 5. Создайте на странице input[type=number] с классом i-5, 
...
// Task 6. Создайте на странице input[type=number] с классом i-6, 
...
// Task 7.
// Даны 2 input - i-71 и i-72, оба - input[type=number]. При нажатии кнопки b-7 
// срабатывает функция f7. Функция должна число из i-71 возвести в степень i-72, 
// вывести результат в  out-7. Для возведения в степень можно использовать **, 
// или Math.pow.
...
// При ее  нажатии срабатывает функция f8. Функция должна получить выбранное в select 
// число, потом с помощью switch case сравнить его поочередно с ‘1’, ‘2’, ‘3’. 
// И если число выбрано - 1, то вывести в out-8 строку one, если 2 - two, 
// если 3 - three.

sel = document.querySelector('.s-8')
outchoos = document.querySelector('.out-8')
function f8(){
selchoos = +sel.value //тут обязательно "+"
switch(selchoos) {
    case 1:
        outchoos.innerHTML = "one";
        break;
    case 2:
        outchoos.innerHTML = "two";
        break;  
    case 3:
        outchoos.innerHTML = "three";
        break;
    default:
        outchoos.innerHTML = "Хрень"
}
}
...
// Task 9
//     Создайте на странице input[type=number] с классом i-9, куда пользователь 
// может ввести номер квартиры. Есть кнопка b-9 которая запускает функцию f9.
...
sel9 = document.querySelector('.i-9')
outchoos9 = document.querySelector('.out-9')
function f9(){
    selchoos = +sel9.value //тут обязательно "+"
    if(selchoos <= 32) {
            outchoos9.innerHTML = "1";
    }
    else if(selchoos <= 43) {
            outchoos9.innerHTML = "2";
         }
    else if(selchoos <= 64) {
            outchoos9.innerHTML = "3";
         }
    else(outchoos9.innerHTML = "нет такого")
}
...
sel = document.querySelector('.s-110')

function f11(){
selval = sel.value;
//Равнозначные варианты:
        // choossel = document.querySelector('.out-11')
        // choossel.innerHTML = sel.value;
document.querySelector('.out-11').innerHTML = sel.value
}
...
let inputnum = document.querySelector('.i-130')
let output = document.querySelector('.out-13')
function f13(){
let inp = inputnum.value; // если добавть + то будет number
output.innerHTML = inp;
document.querySelector('.out-13').innerHTML = (typeof inp);
...
function f14(){
 let n141 = +i141.value
 let n142 = +i142.value
 let oper143 = s143.value
switch(oper143){
    case "+":  out14.innerHTML = n141 + n142;
    break;
    case "-": out14.innerHTML = n141 - n142;
    break;
    case "*": out14.innerHTML = n141 * n142;
